...
### [aupc-compositionAllergy](Composition-aupc-compositionAllergy.json.html) [(Document bundle)](Bundle-aupc-compositionAllergy.json.html)
...
|  | Section | Section references | List references
| --- | --- | --- | --- |
| Subject:[Marcus Welby](Patient-aupc-patient1.json.html) | | |
| Author: [John Doe](Practitioner-aupc-practitioner1.json.html) | | |
| Sections:  | | |
| | Medical History
...
|  | aupc-adverseReactionList | Allergy List |  |
